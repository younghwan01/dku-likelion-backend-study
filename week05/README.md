...
이번 과제는 전체적으로 어려웠습니다. 그중 가장 힘들었던 것은 실행 환경을 맞추는 과정이었습니다.

처음에는 강의 파일을 그대로 열면 바로 실행될 것이라고 생각했지만, 계속해서 오류가 나서 지피티와 함께 해결해 나아갔습니다.

결국 해결이 되지 않아서 비슷한 실습을 먼저 정리한 다른 사람의 README 파일도 참고하면서 문제를 해결하는데 도움을 받았습니다.

실습 내용도 처음에는 어렵고 따라가기 힘들었습니다,

모든 코드를 완벽하게 이해하기보다는 명령어들이나 파일들이 서로 연결되어 동작하는 흐름을 이해하려고 했습니다.
